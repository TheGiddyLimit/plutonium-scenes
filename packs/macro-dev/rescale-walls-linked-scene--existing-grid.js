/**
 * This macro provides a workflow for scaling and copying walls from one pre-gridded scene to another.
 *
 * Usage:
...
(async () => {
	...
	const scaleFactor = sceneTarget.grid.size / sceneSource.grid.size;
